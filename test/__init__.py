...
# )
from .tests.pubsub import (
  test_broker, test_producer, test_consumer,
...
test_registry.register("utils.concurrency.pubsub", "Broker", test_broker)
test_registry.register("utils.concurrency.pubsub", "Producer", test_producer)
test_registry.register("utils.concurrency.pubsub", "Consumer", test_consumer)
test_registry.register("utils.concurrency.pubsub", "Broker_integration", test_broker_integration)
